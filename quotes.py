...
f"You see, {x_com}, you make it too easy. An uneducated, half-brained serving boy with a hangover could make mock of you. I am left with no need to exert myself, and your very nature makes mockery of my mockery. And so it is that through sheer stupidity you make me look incompetent.",
...
f"{x_com}, I salute you. You are what lesser cretins like AlThorStormblessed aspire to be.",
f"I point out truths when I see them, {x_com}. Each man has his place. Mine is to make insults. Yours is to be in-sluts.",
...
f"Ahh {x_com}! You remind me of someone very dear to me. My horse.",
...
intro_list_2 = [
f"Here is a really cute image {y_com} found for you!",
f"{y_com} sends you this really nice image!",
f"Here is something really cute {y_com} has sent you!!!",
f"{y_com} thinks that you should look at this little thing!"
]
...
"Hey, Gancho, you're not the dumbest person on the planet, but you sure better hope they don't die.",
...
"""You've probably heard of the person who lost their arm and leg.

Despite technically being all right, in reality they're dead. But they weren't buried.
...
"I think I made the fellow cry, Gon. They shouldn't trouble you again, and if they doe, you can call me again!"
]


fail_quotes = [
"Sorry, Gancho, but I have already seen to that comment. Can't do that again.",
"I already spoke to that person, and I don't think they need to be insulted.",
...
"A one-armed Herdazian is still twice as useful as a no-brained Alethi.",
"Hey, Gancho, you're not the coolest person on the planet, but you sure better hope they don't die.",
